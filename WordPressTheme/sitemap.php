  ...
  <main>
    <div class="mv-individual">
      ...
      <div class="mv-individual__body">
        <h1 class="mv-individual__title">site Map</h1>
      </div>
    </div>

    <!-- breadcrumb -->
    <div class="sitemap-breadcrumb">
      <div class="sitemap-breadcrumb__inner inner">
        <nav class="breadcrumb">
          <ul class="breadcrumb__lists">
            <li class="breadcrumb__list-item"><a href="index.html">TOP</a></li>
            <li class="breadcrumb__separator">&gt;</li>
            <li class="breadcrumb__list-item">サイトマップ</li>
          </ul>
        </nav>
      </div>
    </div><!-- breadcrumb -->
    ...
    <div class="sitemap-body">
      <div class="sitemap-body__inner inner">
        <div class="sitemap-content">
          <!-- 共通ナビゲーション部分 -->
          <nav class="sitemap-content__nav global-nav global-nav--subpage-sitemap">
            <div class="global-nav__content">
              <div class="global-nav__grid">
                <!-- カラム1 -->
                <div class="global-nav__column global-nav__item1">
                  ...
                  <div class="global-nav__block">
                    <div class="global-nav__heading">
                      <img src="<?php echo esc_url( get_theme_file_uri() ); ?>/assets/images/hitode-icon-black.png" alt="ヒトデのアイコン" class="global-nav__icon">

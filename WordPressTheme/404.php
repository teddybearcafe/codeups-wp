...
<body class="page404-body">
  ...
  <main class="main-wrapper">
    ...
    <div class="page404-breadcrumb">
      <div class="page404-breadcrumb__inner inner">
        <nav class="breadcrumb breadcrumb--white" aria-label="パンくずリスト">
          <ul class="breadcrumb__lists">
            <li class="breadcrumb__list-item"><a href="index.html">TOP</a></li>
            <li class="breadcrumb__separator">&gt;</li>
            <li class="breadcrumb__list-item">404</li>
          </ul>
        </nav>
      </div>
    </div>
    ...
    <section class="page404-contents">
      <div class="page404-contents__inner inner">
        <img class="page404-contents__image" src="<?php echo get_theme_file_uri(); ?>/assets/images/page-404error-bg.svg" alt="背景画像">
  ...
  <footer class="footer page404-footer" id="footer">

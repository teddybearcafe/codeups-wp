  ...
  <main>
    <div class="mv-individual">
      <picture class="mv-individual__img">
        <source srcset="<?php echo get_theme_file_uri(); ?>/assets/images/contact-mv.jpg" media="(min-width: 767px)">
        <img src="<?php echo get_theme_file_uri(); ?>/assets/images/contact-mv-sp.jpg" alt="砂浜に波が寄せる様子">
      </picture>
      ...
      <div class="thanks-breadcrumb__inner inner">
        <nav class="breadcrumb">
          <ul class="breadcrumb__lists">
            ...
            <li class="breadcrumb__list-item"><a href="contact.html">お問い合わせ</a></li>
            <li class="breadcrumb__separator">&gt;</li>
            <li class="breadcrumb__list-item">送信完了</li>
          </ul>
        </nav>
      </div>
    </div><!-- breadcrumb -->

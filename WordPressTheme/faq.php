  ...
  <main>
    <div class="mv-individual">
      <picture class="mv-individual__img">
        <source srcset="<?php echo get_theme_file_uri(); ?>/assets/images/faq-mv.jpg" media="(min-width: 767px)">
        <img src="<?php echo get_theme_file_uri(); ?>/assets/images/faq-mv-sp.jpg" alt="白い砂浜とエメラルドグリーンの海が広がるビーチ">
      </picture>

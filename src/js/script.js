...
jQuery(function ($) {
  ...
  //要素の取得とスピードの設定
  var box = $(
      ".voice-card__figure , .information__image , .price__header-image"
    ),
    speed = 700;
  ...
  $(".faq-accordion__header").on("click", function () {
    ...
    if (isOpen) {
      ...
      $panel
        .addClass("faq-accordion__panel--is-close")
        .removeClass("faq-accordion__panel--is-open");
    } else {
      // アコーディオンを開く
      $target.addClass("faq-accordion__header--is-open");
      $panel
        .removeClass("faq-accordion__panel--is-close")
        .addClass("faq-accordion__panel--is-open");
    }
  });
});
